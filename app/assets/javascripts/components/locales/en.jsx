...
const en = {
  ...
  "column.home": "/home/@{name}",
  "column.mutes": "Muted users",
  "column.notifications": "/var/notifications",
  ...
  "compose_form.privacy_disclaimer": "Your post will be delivered to mentioned users on {domains}. Do you trust {domainsCount, plural, one {that server} other {those servers}}? Post privacy only works on Mastodon instances. If {domains} {domainsCount, plural, one {is not a Mastodon instance} other {are not Mastodon instances}}, there will be no indication that your post is not a public post, and it may be relayed or otherwise made visible to unintended recipients.",
  ...
  "empty_column.home": "You aren't following anyone yet. Visit {public} or use grep to get started and meet other users.",
  ...
  "notifications.column_settings.reblog": "Relays:",
  ...
  "search.placeholder": "grep",
  "search.status_by": "Status by {name}",
  "search_results.total": "{count, number} {count, plural, one {result} other {results}}",
  "status.cannot_reblog": "This status cannot be relayed",
